...
function ProfileSidebar({ picture}) {
    ...
    return (
        ...
        <div className="flex flex-col min-h-screen w-56 shadow-md mt-1 bg-white rounded-r-3xl overflow-hidden">
            ...
            <li>
            <Link to="/updateprofile" className="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800" href="#">
