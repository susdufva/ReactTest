    ...
    return (
        <>
            <div className="flex flex-row justify-center mt-20">
                <div className="mr-8 grid place-items-center mx-2 my-20 sm:my-auto">
            <div className="w-80 h-96 px-6 py-10 sm:px-10 sm:py-6 bg-white rounded-lg shadow-md lg:shadow-lg">
                ...
                <form className="mt-12" onSubmit={handleOnSubmit} method="POST">
                    ...
                    <input id="email" type="email" name="email" placeholder="e-mail" value={newValue.email} onChange={handleOnChange}
                        ...
                        focus:text-gray-500 focus:outline-none focus:border-gray-200" />
                    <button type="submit"
                        className="w-9/12 py-2 mt-20 bg-gray-800 rounded-xl
